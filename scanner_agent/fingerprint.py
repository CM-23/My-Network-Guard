...
_HOSTNAME_PATTERNS: list[tuple[list[str], str, str, int]] = [
    ...
    (["macbook", "imac", "mac-", "macmini", "macpro", "mac-pro"],
                                                    DeviceType.PC,      "macOS",            95),
    (["android-"],                                  DeviceType.PHONE,   "Android",          92),
    (["desktop-", "laptop-", "win-", "windows"],    DeviceType.PC,      "Windows",          90),
    (["printer", "print", "laserjet", "deskjet",
      "officejet", "epson", "pixma", "mfc-"],       DeviceType.PRINTER, "Embedded RTOS",    90),
    (["tv", "roku", "firetv", "chromecast",
      "smarttv", "shield", "bravia"],               DeviceType.TV,      "Smart TV OS",      88),
    (["samsung-tv", "lg-tv", "lgtv"],               DeviceType.TV,      "Smart TV OS",      90),
    (["router", "gateway", "ap-", "modem", "switch",
      "hub", "access-point"],                       DeviceType.ROUTER,  "Linux/Embedded",   85),
    (["camera", "cam-", "ipcam", "dvr", "nvr",
      "nest", "ring", "arlo"],                      DeviceType.CAMERA,  "Embedded Linux",   85),
    ...
    (["linux", "ubuntu", "debian", "fedora",
      "centos"],                                   DeviceType.SERVER,  "Linux",            80),
