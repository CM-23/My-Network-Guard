...
_HOSTNAME_PATTERNS: list[tuple[list[str], str, str, int]] = [
    ...
    (
        ["tv", "roku", "firetv", "chromecast", "smarttv", "shield", "bravia"],
        DeviceType.TV,
        "Smart TV OS",
        88,
    ),
    ...
    (
        ["router", "gateway", "ap-", "modem", "switch", "hub", "access-point"],
        DeviceType.ROUTER,
        "Linux/Embedded",
        85,
    ),
    (
        ["camera", "cam-", "ipcam", "dvr", "nvr", "nest", "ring", "arlo"],
        DeviceType.CAMERA,
        "Embedded Linux",
        85,
    ),
    ...
    (
        ["raspberrypi", "raspberry-pi", "pi-model"],
        DeviceType.IOT,
        "Raspberry Pi OS",
        88,
    ),
