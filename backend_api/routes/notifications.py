...
from shared.validators import validate_chat_id, validate_bot_token, validate_webhook_url
from common.exceptions import ValidationError, SSRFAttemptError
...
def save_telegram_config():
    try:
        ...
        telegram_agent.update_config({
            "telegram": {"bot_token": bot_token, "chat_id": cfg.telegram.chat_id}
        })
        save_config(cfg)
